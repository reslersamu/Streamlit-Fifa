...
if "data" not in st.session_state:
    df_data = pd.read_csv(r'C:\Users\Usuario\OneDrive - Governo do Estado do Rio Grande do Sul\Documents\GitHub\Streamlit-Fifa\CLEAN_FIFA23_official_data.csv', index_col=0)
